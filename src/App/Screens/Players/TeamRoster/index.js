...
function TeamRoster(props) {
  ...
  const updatePlayerData = () => {
    ...
    fetch(
      "https://nodeserver.mydevfactory.com:1448/api/update-player-details",
      requestOptions
    )
      .then((response) => response.json())
      .then((res) => {
  ...
  const playerDitails = (id) => {
    ...
    axios({
      ...
      url:
        "https://nodeserver.mydevfactory.com:1448/api/getRoasterDetailsById?rosterId=" +
        id,
      headers: {
        token: user.authtoken,
      },
                              ...
                              {player._id != null ? (
                                <>
                                  <tr>
                                    ...
                                    <td>
                                      <span>
                                        {player.contactInformationAddress}
                                      </span>
                                    </td>
                          ...
                          <div className="col-md-12">
                            <div className="prefarance-form-list">
                              ...
                              <select
                                ...
                                defaultValue={
                                  newplayerdata[id].member_id.gender
                                }
                              >
                          ...
                          <div className="col-md-12">
                            <div className="prefarance-form-list">
                              ...
                              <input
                                ...
                                defaultValue={
                                  newplayerdata[id].member_id?.fname
                                }
                              />
                            </div>
                          </div>
                          <div className="col-md-12">
                            <div className="prefarance-form-list">
                              ...
                              <input
                                ...
                                defaultValue={
                                  newplayerdata[id].member_id?.lname
                                }
                              />
                            </div>
                          </div>
                          ...
                          <>
                            <div className="plr_dtls_wrp">
                              ...
                              <div className="plr_dtls_itm">
                                ...
                                <span> {ditails.playerGender}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                              ...
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Email: </label>
                                <span>{ditails.contactInformationEmail}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Address: </label>
                                <span>{ditails.contactInformationAddress}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>City: </label>
                                <span>{ditails.contactInformationCity}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>State: </label>
                                <span>{ditails.contactInformationState}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Zip: </label>
                                <span>{ditails.contactInformationZipCode}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                              ...
                              <div className="plr_dtls_itm">
                                ...
                                <span>{ditails.playerBirthday}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Position: </label>
                                <span>{ditails.position}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Jersey no: </label>
                                <span>{ditails.jerseyNumber}</span>
                              </div>
                              <div className="plr_dtls_itm">
                                {" "}
                                <label>Phone: </label>
                                <span>
                                  {ditails.contactInformationPhoneNumber}
                                </span>
                              </div>
                            </div>
                            <div>
                              ...
                              {non_Player._id != null ? (
                                <>
                                  <tr>
                                    ...
                                    <td>
                                      <span>
                                        {non_Player.contactInformationAddress}
                                      </span>
