...
function ManagerHome(props) {
  ...
  const uploadImage = (value) => {
    ...
    axios(
      "https://nodeserver.mydevfactory.com:1448/api/update-team-profile-image",
      {
        method: "POST",
        headers: {
  ...
  const teamRoster = () => {
    ...
    if (user) {
      ...
      Network(
        "api/player-list-by-team-id?team_id=" + team_id,
        "GET",
        header
      ).then(async (res) => {
                  ...
                  <div className="invoice-due">
                    <div className="create-new-team-section">
                      ...
                      <div className="create-new-team-text">
                        <h3>
                          Did you know XYZ supports over 100 different sports &
                          activities?
                        </h3>
                        <p>
                          Use XYZ for everything from soccer, football or
                          baseball to scouts,gaming or book clubs. It’s easy to
                          start a new group. Try it today!
                        </p>
                        <button
                          onClick={() => {
                            history.push("/CreateTeam");
            ...
            <div className="record-save-section">
              ...
              <div className="save-travel tb-section">
                <div className="standing-tb-section">
                  <div className="record-standing-head">Standings</div>
