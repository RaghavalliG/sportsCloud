...
const NewEvent = () => {
  ...
  const eventCreate = () => {
    ...
    fetch(
      "https://nodeserver.mydevfactory.com:1448/api/addEvents",
      requestOptions
    )
      ...
      <div className="dashboard-main-content">
        <div className="dashboard-head">
          <div className="teams-select">
            ...
            <select
              onChange={change}
              value={teamDropdown == "" ? dropdown[0]?.team_id : teamDropdown}
            >
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="prefarance-form-list">
                        ...
                        />
                        <p style={{ color: "gray" }}>
                          A short label to identify the types of event, 10
                          character max
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="prefarance-form-list">
                        ...
                        <p style={{ color: "gray" }}>
                          {" "}
                          minutes befor the starting time
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-12">
                      <div className="prefarance-form-list">
                        ...
                        <input
                          ...
                          onChange={(e) => setAvalability(e.target.value)}
                        />
                        <span style={{ color: "white" }}>
                          Track availability on the Availability tab
                        </span>
                      </div>
                    </div>
                    {/* <div className="col-md-6">
                    ...
                    <div className="col-md-12">
                      <div className="prefarance-form-list">
                        ...
                        <div className="mb-4">
                          ...
                          <button className="add-links mr-2">Cancel</button>
                          <button
                            className="btn "
                            style={{
                              backgroundColor: "#1d1b1b",
